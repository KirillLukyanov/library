...
Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])('[data-toggle="modal"]').modal(); // function calcScrollWidth() {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.setAttr = function (attr, value) {
  for (let i = 0; i < this.length; i++) {
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').click(() => Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').createModal({
  ...
  btns: {
    count: 3,
    settings: [['Close', ['btn-danger', 'mr-10'], true], ['Save changes', ['btn-success'], false, () => alert('Данные сохранены')], ['Another button', ['btn-warning', 'ml-10'], false, () => alert('Hello')]]
  }
}));
